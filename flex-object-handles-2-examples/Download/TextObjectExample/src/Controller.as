package
{
	...
	public class Controller
	{
		...
		/*
			...
			Write a method to add a TextModel object to our datamodel of on screen items.
			
			Go check out TextModel.as to see what that looks like.
			
			Note that we set scaleText here, that's important to remember when we look at 
			the View object.
			
			Go see TextView.mxml for Step 5
		*/
